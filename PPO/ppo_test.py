...
class Agent:
    def __init__(self, state_dim, action_dim, gamma=0.99, lamda=0.99, clip=0.2,
...
def ppo_train(env, agent, n_episode=1000, update_step=2000):
    ...
    for episode in range(n_episode):
        ...
        print(f"Epsode {episode:04}, steps taken {episode_steps:04}, total score {total_steps:07}, learn steps {learn_steps:04},",
              f"total reward {total_reward:1f}, avg reward {avg_score:1f}")
