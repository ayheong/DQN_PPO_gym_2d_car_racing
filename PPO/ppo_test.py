...
def ppo_train(env, agent, n_episode, update_step):
    ...
    for episode in range(n_episode):
        ...
        print(f"Episode: {episode:04}, epsode steps: {episode_steps:04}, total steps: {total_steps:07}, learn steps: {learn_steps:04},",
...
if __name__ == "__main__":
    ...
    if train:
        ...
        tot_loss = [item[0] + item[1] for item in loss]
        ...
        print("... start testing ...")
        env = Env(render=True)
        agent = Agent(state_dim=4, action_dim=3, save_dir='./ppo_test_model')
        agent.load_model()
